...
class EmailTemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create email_template" do
    assert_difference("EmailTemplate.count") do
      post email_templates_url, params: { email_template: { body: @email_template.body, title: @email_template.title } }
    end
  ...
  test "should update email_template" do
    patch email_template_url(@email_template), params: { email_template: { body: @email_template.body, title: @email_template.title } }
