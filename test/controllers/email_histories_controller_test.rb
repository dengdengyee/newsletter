...
class EmailHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create email_history" do
    assert_difference("EmailHistory.count") do
      post email_histories_url, params: { email_history: { body: @email_history.body, receiver: @email_history.receiver, subject: @email_history.subject } }
    end
  ...
  test "should update email_history" do
    patch email_history_url(@email_history), params: { email_history: { body: @email_history.body, receiver: @email_history.receiver, subject: @email_history.subject } }
